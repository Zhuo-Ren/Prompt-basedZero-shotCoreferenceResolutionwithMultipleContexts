...
# config
config_dict = {
    "corpus_and_mention_pair_path": r"E:\ProgramCode\WhatGPTKnowsAboutWhoIsWho\WhatGPTKnowsAboutWhoIsWho-main\Models2\data\extract_mention_pairs_from_test_data\strategy_3_corpus_and_mention_pairs",
...
def main():
    for cur_model_name, cur_model_config in config_dict["models"].items():
        for cur_template_id in config_dict["templates"]:
            # read corpus
            with open(config_dict["corpus_and_mention_pair_path"], 'rb') as f:
            ...
            #
            config_dict["file_name"] = f"{cur_model_name}_{config_dict['data']}_t{cur_template_id}_s0_b1_noSample"
