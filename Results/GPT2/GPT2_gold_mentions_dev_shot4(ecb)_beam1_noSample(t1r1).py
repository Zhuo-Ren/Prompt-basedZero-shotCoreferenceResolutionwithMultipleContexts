...
# 配置数据
"""这一部分配置在后边"""
data_config = "dev"  # "dev"完整的DevSet "firstTwoDocs"只用头两个文档做实现 "givenDoc"只针对给定文档做实现
...
# 配置模型参数
n_shot = n_examples = 4  # n-shot。就是从下边的simple_examples中选前n个用于生成prefix。也就是prefix中包含n个example，也就是n-shot。
do_sample = False
num_beams = 1
temperature = 1
